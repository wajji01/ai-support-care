  ...
  const features = [
    {
      ...
      description:
        "Provide round-the-clock assistance to your customers, ensuring they receive immediate responses to their inquiries, even outside of regular business hours.",
    },
    {
      title: "Personalized Support",
      description:
        "Tailor support to each customer based on their unique needs, preferences, and concerns, ensuring a personalized and effective experience.",
    },
    {
      title: "Multilingual Support",
      description:
        "Break down language barriers and provide support in multiple languages, allowing you to serve a global customer base with ease.",
    },
  ];
              ...
              <AnimatePresence>
                {open && (
                  ...
                  >
                    ...
                    <button
                      className=" block w-full text-left text-red-600 px-4 py-3 text-sm hover:bg-zinc-100"
          ...
          <div className=" max-w-6xl mx-auto grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              <h1 className=" text-4xl md:text-5xl font-semibold leading-tight">
                Custumer Support<span className=" text-zinc-400"> AI</span>{" "}
                <br />
                Build for modren websites
              </h1>
              <p className=" mt-6 text-lg text-zinc-600 max-w-xl">
                Add a powerful AI chatbot to your website to deliver 24/7
                instant support, intelligently understand and respond to
                customer inquiries in real time, boost customer satisfaction,
                reduce response times, and streamline your support operations
              ...
              <div className=" rounded-2xl bg-white shadow-2xl border border-zinc-200 p-6">
                ...
                <div className=" space-y-3">
                  ...
                  <div className=" bg-zinc-100 rounded-lg px-4 py-2 text-sm w-fit">
                    Yes, we do offer cash on delivery for all orders.
                  </div>
                </div>
                <motion.div
                  animate={{ y: [0, 12, 0] }}
          ...
          <div className=" mt-16 grid grid-cols-1 md:grid-cols-3 gap-10">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: false }}
                className=" bg-white rounded-2xl shadow-lg border border-zinc-200 p-8"
              >
                <div>
